...
export function PlatformFavicon({ info }: { info: PlatformInfo }) {
  ...
  // Exact vector icons for the 5 primary platforms matching the provided designs
  switch (info.key) {
    case "atcoder":
      return (
        <svg viewBox="0 0 24 24" className="h-4 w-4 shrink-0 fill-slate-900" aria-hidden="true">
    ...
    case "codeforces":
      return (
        <svg viewBox="0 0 24 24" className="h-4 w-4 shrink-0" aria-hidden="true">
          <rect x="2" y="9.5" width="5.2" height="12.5" rx="1.5" fill="#FFC107" />
          <rect x="9.4" y="2" width="5.2" height="20" rx="1.5" fill="#0088FE" />
          <rect x="16.8" y="6.5" width="5.2" height="15.5" rx="1.5" fill="#F44336" />
        </svg>
      );
    case "leetcode":
      return (
        <svg viewBox="0 0 24 24" className="h-4 w-4 shrink-0" aria-hidden="true">
          <path fill="#262626" d="M16.102 17.93a4.547 4.547 0 0 1-1.252.13c-2.453 0-4.041-1.782-4.041-4.48 0-2.69 1.6-4.48 4.041-4.48.455 0 .878.053 1.252.13.374.077.7.195 1.002.355v-2.31a6.666 6.666 0 0 0-2.254-.388c-4.041 0-6.852 2.766-6.852 6.693 0 3.927 2.811 6.693 6.852 6.693 1.026 0 1.832-.152 2.254-.388v-2.31a5.617 5.617 0 0 1-1.002.355z" />
          <path fill="#FFA116" d="M13.483 0a1.374 1.374 0 0 0-.961.438L7.116 6.226l-3.854 4.126a5.266 5.266 0 0 0-1.209 2.135 5.31 5.31 0 0 0-.097 2.438c.135.9.57 1.737 1.238 2.373l3.29 3.123 3.855 3.658a1.368 1.368 0 0 0 1.93-.06 1.367 1.367 0 0 0 .06-1.93l-3.855-3.658a2.532 2.532 0 0 1-.593-1.134 2.57 2.57 0 0 1 .046-1.168 2.52 2.52 0 0 1 .58-.1l3.854-4.126 5.406-5.788A1.368 1.368 0 0 0 13.483 0z" />
        </svg>
      );
    case "codechef":
      return (
        <svg viewBox="0 0 24 24" className="h-4 w-4 shrink-0" aria-hidden="true">
          <path fill="#795548" d="M12.44 2C9.4 2 6.84 4.14 6.22 7C4.1 7.42 2.5 9.3 2.5 11.5c0 2.45 1.88 4.47 4.28 4.71v3.29a1.5 1.5 0 0 0 1.5 1.5h7.44a1.5 1.5 0 0 0 1.5-1.5v-3.29c2.4-.24 4.28-2.26 4.28-4.71 0-2.2-1.6-4.08-3.72-4.5.21-.6.32-1.24.32-1.9 0-3.04-2.56-5.4-5.6-5.4z" />
          <rect x="6.5" y="11" width="11.8" height="2.2" fill="#D32F2F" rx="0.5" />
          <path fill="#4E342E" d="M8.28 18.5h7.44v1.5H8.28v-1.5z" />
        </svg>
      );
    case "geeksforgeeks":
      return (
        <svg viewBox="0 0 24 24" className="h-4 w-4 shrink-0" aria-hidden="true">
          <path fill="#2F9E44" d="M19.146 8.329c-.382.493-.827.876-1.334 1.149a4.846 4.846 0 0 1-2.298.547c-.779 0-1.5-.16-2.164-.479a4.67 4.67 0 0 1-1.623-1.368l2.128-1.745c.342.424.717.733 1.127.927a2.52 2.52 0 0 0 1.077.291c.424 0 .786-.098 1.087-.294.301-.196.536-.458.705-.786.169-.328.254-.693.254-1.095 0-.465-.113-.865-.339-1.201a2.28 2.28 0 0 0-.903-.797 3.328 3.328 0 0 0-1.378-.328c-.533 0-1.012.113-1.437.339-.425.226-.759.544-1.002.955l-2.073-1.69c.479-.766 1.134-1.354 1.967-1.764C12.553 1.585 13.524 1.38 14.612 1.38c1.066 0 2.057.219 2.973.657a6.224 6.224 0 0 1 2.215 1.834c.595.785.893 1.703.893 2.754 0 1.053-.298 1.972-.893 2.757z" />
          <path fill="#2F9E44" d="M4.854 8.329c.382.493.827.876 1.334 1.149a4.846 4.846 0 0 0 2.298.547c.779 0 1.5-.16 2.164-.479a4.67 4.67 0 0 0 1.623-1.368L10.145 6.433a2.637 2.637 0 0 1-1.127.927 2.52 2.52 0 0 1-1.077.291c-.424 0-.786-.098-1.087-.294a1.737 1.737 0 0 1-.705-.786c-.169-.328-.254-.693-.254-1.095 0-.465.113-.865.339-1.201.226-.336.527-.602.903-.797.376-.195.835-.304 1.378-.328.533 0 1.012.113 1.437.339.425.226.759.544 1.002.955l2.073-1.69c-.479-.766-1.134-1.354-1.967-1.764C11.447 1.585 10.476 1.38 9.388 1.38c-1.066 0-2.057.219-2.973.657a6.224 6.224 0 0 0-2.215 1.834C3.605 4.656 3.307 5.574 3.307 6.625c0 1.053.298 1.972.893 2.757z" />
          <rect x="0.5" y="11" width="23" height="2" fill="#2F9E44" />
        </svg>
      );
    case "other":
    default:
